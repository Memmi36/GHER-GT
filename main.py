...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/briareo/briareo_com_9_ghergt.yaml',
...
class Processor():
    ...
    def load_data(self):
        ...
        print(f"Length of test dataset: {len(self.data_loader['test'])}")
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            pred_list = []
            step = 0
            x=self.data_loader[ln]
            print("*****")
            print(f"Length of test_loader: {len(x)}")
            print("*****")
            process = tqdm(x)
